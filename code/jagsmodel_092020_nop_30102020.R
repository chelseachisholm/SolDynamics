...
jagsModel_nop_v2 = jags.model(file= "occ1.txt", data=Data_simple, n.chains = 3, n.adapt= 500, inits = inits_fn)
...
Samples = coda.samples(jagsModel_nop_v2, variable.names = para.names, n.iter = 1000, na.rm=F)
...
save(Samples, file='modeloutput112020.RData')
